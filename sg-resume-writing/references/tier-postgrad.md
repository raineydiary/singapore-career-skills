# 硕士 / 有工作经验档（SMU 规范为基准，NUS MSc 模板补充）

适用：管理类/专业硕士求职、有全职经验的转职者、resume book 收录场景。

## Section 结构（顺序固定，仅此四块）
...
NUS MSc 变体允许把 ADDITIONAL 命名为 SKILLS AND ACTIVITIES 或自定标题；结构逻辑不变。
...
- 日期右对齐；全文左对齐、禁止两端对齐
- section / 学校 / 雇主之间空一整行
- 地点紧跟学校/雇主名后（`EMPLOYER NAME – Singapore`）
- 每个职位 **2–4 条 bullet**；越早的职位越少
- bullet 末尾不加句号

## Education 写法

- 学位名全称："Master of Science in Quantitative Finance"，**Master 不加 s**
- **禁用** "Candidate"、"Anticipated Graduation"、"Expected Graduation"、"Expected Honours" 类措辞——直接把预计毕业年月右对齐写上
- GPA >3.4（4.0 制）才写；GMAT >660 才写（NUS 标准：CAP >4.0/5.0、GMAT >700——按用户学校取对应门槛，通用取 SMU 线）
- 本科条目保留 honours、奖学金、交换经历（一行带日期："Exchange programme at University of Toronto, Canada (Jan – Apr 2016)"）

## Experience 写法

同一雇主多个职位（内部晋升）的排版——雇主日期右对齐，各职位日期加括号：

```
EMPLOYER NAME – Singapore                              Jul 2017 – Jul 2022
Position Title, Senior (Jul 2019 – Jul 2022)
• bullet…
Position Title, Junior (Jul 2017 – Jul 2019)
• bullet…
```
...
```
• Professional certifications: CFA Level II; CACS Paper 1 & 2
